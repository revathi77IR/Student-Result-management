...
Sivashti selvi
Attachments
Wed, Nov 17, 10:55 PM (12 hours ago)
to me
...
session_start();
error_reporting(0);
include('C:\wamp\www\Student Result Management System\srms\includes\config.php');
...
<input type="text" name="total" class="form-control" id="marks" value="<?php echo htmlentities($k);?>" maxlength="5" required="required" autocomplete="off">   
</div>
</div>                                
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Average</label>
<div class="col-sm-10">
 <input type="text" name="total" class="form-control" id="marks" value="<?php echo htmlentities($k/6);?>" maxlength="5" required="required" autocomplete="off">   
</div>
</div>
<div class="form-group">
                                            <label for="default" class="col-sm-2 control-label">Result</label>
                                                        <div class="col-sm-10">


<input type="text" name="total" class="form-control" id="marks" value="<?php echo htmlentities($view);?>" maxlength="5" required="required" autocomplete="off">   
</div>
</div>      
<?php 
if($k/6>=90 && $k/6<=100)
...
else if($k/6>=80 && $k/6<90)	
{
$grade="B";
}
else if($k/6>=70 && $k/6<80)	
{
$grade="C";
}
else if($k/6>=60 && $k/6<70)	
{
$grade="D";
}
else	
...
<input type="text" name="total" class="form-control" id="marks" value="<?php echo htmlentities($grade);?>" maxlength="5" required="required" autocomplete="off">   
</div>
</div>       
	 <div class="form-group">
